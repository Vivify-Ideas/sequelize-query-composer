...
module.exports = class Search {
    ...
    extractAssociations(parsedQuery) {
        ...
        let associationsNames = parsedQuery[this.fieldNames.details];
        if (!Array.isArray(associationsNames)) {
            associationsNames = this.splitByAndFilter(parsedQuery[this.fieldNames.details], this.fieldNames.associationDelimiter);
        }
