...
module.exports = class Search {
    ...
    extractWhereConditions(parsedQuery) {
        let whereConditions = _.omit(parsedQuery, Object.values(this.fieldNames));

        return _.pick(whereConditions, this.getAllModelFields());
    };
    ...
    extractAssociations(parsedQuery) {
        ...
        return _.compact(associationsNames.map(associationName => this.mappedAssociations[associationName]));
    };
    ...
    getOnlyModelFields(fields) { return _.intersection(fields, this.getAllModelFields()); }
